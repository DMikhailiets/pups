...
const MainInfoBar: React.FC<MainInfoBarProps> = ({activePUP}) => {
    return (
    <>
        {
            activePUP === null
            ? <div className={styles.emptyWrapper} style={{minHeight: '100%'}}><Empty description='Выберите плату управления питанием'/></div>
